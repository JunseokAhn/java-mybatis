...
public class dao2 {
	...
	public boolean buyCancel(String id, int no, int stock) {
		SqlSession session = null;
		Tyuumon tyu = null;
		Syoubinn syo = null;
		Bridge bri = null;
		...
		try {
			session = factory.openSession();
			Mapper2 mapper2 = session.getMapper(Mapper2.class);
			tyu = new Tyuumon(no,id,stock);
			res = mapper2.buyCancel(tyu);

				
			bri = new Bridge(no,0);	
			syo =  mapper2.selectSyo(bri);
			syo.setStock(stock);
...
//	}
	...
	public boolean checkStock2(int tyuumon_id, int stock) {
		// TODO Auto-generated method stub
		SqlSession session = factory.openSession();
		Mapper2 mapper2 = session.getMapper(Mapper2.class);
		HashMap<String, Integer> map = new HashMap<>();
		map.put("tyuumon_id", tyuumon_id);
		map.put("stock", stock);
		int res = mapper2.checkStock2(map);
	...
	public boolean checkCancle(int tyuumon_id) {
		// TODO Auto-generated method stub
		SqlSession session = factory.openSession();
		Mapper2 mapper2 = session.getMapper(Mapper2.class);
		Bridge B = mapper2.checkCancle(tyuumon_id);
	...
	public boolean getBridge2(int no) {
		// TODO Auto-generated method stub
		SqlSession session = factory.openSession();
		Mapper2 mapper2 = session.getMapper(Mapper2.class);
		mapper2.getBridge2(no);
		return false;
	}
